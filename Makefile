...
all: map block convpoly regrid fit
	rm bin/*.o
...
fit: bin/fit.o bin/features.o bin/model.o bin/matrix.o bin/stats.o
	$(CC) $(LIBS) bin/fit.o bin/features.o bin/model.o bin/matrix.o bin/stats.o -o bin/fit
